...
pub unsafe extern "C" fn Vapor_Blowfish_encipher(
    ...
    Xr
        ^= ((*s
            .offset(
                (Xl >> 24 as libc::c_int & 0xff as libc::c_int as libc::c_uint) as isize,
            ))
            .wrapping_add(
                *s
                    .offset(
            ...
            ^ *s
                .offset(
                    (0x200 as libc::c_int as libc::c_uint)
                        .wrapping_add(
                            Xl >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_uint,
                        ) as isize,
                ))
            .wrapping_add(
                *s
    ...
    Xl
        ^= ((*s
            .offset(
                (Xr >> 24 as libc::c_int & 0xff as libc::c_int as libc::c_uint) as isize,
            ))
            .wrapping_add(
                *s
                    .offset(
            ...
            ^ *s
                .offset(
                    (0x200 as libc::c_int as libc::c_uint)
                        .wrapping_add(
                            Xr >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_uint,
                        ) as isize,
                ))
            .wrapping_add(
                *s
...
#[no_mangle]
pub unsafe extern "C" fn vapor_blf_dec(
    mut c: *mut blf_ctx,
    mut data: *mut u_int32_t,
    mut blocks: u_int16_t,
) {
